# this_file: vexy-lines-cli/src/vexy_lines_cli/automation/bridges.py
...
class AppleScriptBridge:
    ...
    Wraps macOS osascript calls for activating the app, opening files,
    clicking menu items, sending keystrokes, and querying window titles.
    """
