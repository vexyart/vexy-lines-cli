# this_file: vexy-lines-cli/src/vexy_lines_cli/export/exporter.py
"""Single concrete exporter for Vexy Lines dialog-less export.

Orchestrates the five-stage export pipeline:
...
from vexy_lines_cli.automation.bridges import AppleScriptBridge
from vexy_lines_cli.automation.window_watcher import WindowWatcher
from vexy_lines_cli.export.config import ExportConfig  # noqa: TCH001
from vexy_lines_cli.export.errors import AutomationError
from vexy_lines_cli.export.plist import PlistManager
...
class VexyLinesExporter:
    """Batch exporter that drives the Vexy Lines app via plist injection and AppleScript."""
    ...
    def export(self, input_path: Path, output_path: Path | None = None) -> ExportStats:
        ...
        Args:
            input_path: A .lines file or directory containing .lines files.
            output_path: Optional destination file or directory.

        Returns:
            ExportStats with outcome counts and timing.
        """
